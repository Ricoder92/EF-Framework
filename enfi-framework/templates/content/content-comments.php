...
$comments_args = array(
    ...
    'class_submit'      => 'btn',
    'name_submit'       => 'gf-comments-submit',
    ...
    'comment_field' => '<textarea rows="5" class="gf-comments-textarea" id="comment" name="comment" aria-required="true"></textarea>',
	'logged_in_as' => ''
);


echo "<div class=\" gf-comment\">";
...
<?php
	...
	protected function html5_comment( $comment, $depth, $args ) {
		$tag = ( 'div' === $args['style'] ) ? 'div' : 'li';
?>
		<<?php echo $tag; ?> class="gf-comment" id="comment-<?php comment_ID(); ?>" <?php comment_class( $this->has_children ? 'parent' : '', $comment ); ?>>
			<div id="div-comment-<?php comment_ID(); ?>" class=" comment-body">
                <div class="media">
