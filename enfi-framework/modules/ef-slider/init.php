...
function ef_slider_enqueue_css_js() {
    ...
    wp_register_style('swiper-ef', get_template_directory_uri().'/modules/ef-slider/style.css');
...
function ef_slider_register_block() {
    wp_register_script(
        'ef-slider-slide',
        get_template_directory_uri().'/modules/ef-slider/block/ef-slide.js',
        array( 'wp-blocks', 'wp-element' )
    );
 
    register_block_type( 'ef-slider/slider', array(
        'editor_script' => 'ef-slider-slide',
    ) );
...
$meta_slider = new EF_Metabox('ef-slider-meta', __('SLIDER_SETTINGS', 'ef'), array('slider'));
