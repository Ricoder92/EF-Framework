...
class EF_Widget_Categories extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array( 
			...
			'description' => __('EF_WIDGET_CATEGORIES_DESCRIPTION', 'ef'),
		);
		parent::__construct( 'ef_widget_categories', __('EF_WIDGET_CATEGORIES_NAME', 'ef'), $widget_ops );
	}
	...
	public function form( $instance ) {
        ...
        $post_type = ! empty( $instance['category'] ) ? $instance['category'] : esc_html__( 'post');
		?>
		<p>
