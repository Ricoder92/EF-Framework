...
$settings_page = new EF_Settings_Page('ef-settings', __('SETTINGS', 'ef'), __('SETTINGS', 'ef'), __('SETTINGS_DESCRIPTION', 'ef'), 'settings', null, 1);
...
$settings = ef_get_option('ef-settings');
