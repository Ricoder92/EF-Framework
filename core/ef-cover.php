...
$cover->addSection('cover-settings', __('COVER_SETTINGS', 'ef'));
$cover->addField('cover-settings', 'enable-post-types', __('POST_TYPES', 'ef'), null, 'checkbox-group', null, array( 'post_types' => get_post_types()));
